                        ...
                        <div className="mt-5">
                           ...
                           <p className="text-red text-xs hidden">
                                ...
                                <div class="w-full flex flex-col mb-3 text-xs">
                                    ...
                                    <select class="block w-full bg-white text-grey-darker border border-grey-lighter rounded-lg h-10 px-4 md:w-full " required="required" name="category" id="category">
