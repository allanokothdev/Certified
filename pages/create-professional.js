...
export default function CreateProfessional( visible, onClose ) {
                    ...
                    <div className="mt-5">
                        <div className="form">
                            ...
                            <div className="mt-5 text-right md:space-x-3 md:block flex flex-col-reverse">
                                <button onClick={handleOnClose} className="mb-2 md:mb-0 bg-white px-5 py-2 text-sm shadow-sm font-medium tracking-wider border text-gray-600 rounded-full hover:shadow-lg hover:bg-gray-100">
                                    {" "}
                                    Cancel{" "}
                                </button>
