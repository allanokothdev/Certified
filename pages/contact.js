                    ...
                    <div class="flex flex-wrap -m-3">
                        <div class="w-full md:w-1/3 p-3">
                            <div class="p-11 h-full text-center bg-white bg-opacity-90 border border-blueGray-100 rounded-xl shadow-11xl">
                                ...
                                <p class="font-medium leading-relaxed">info@certified.com</p>
                                <p class="font-medium leading-relaxed">support@certified.com</p>
                            </div>
                        </div>
                        <div class="w-full md:w-1/3 p-3">
                            <div class="p-11 h-full text-center bg-white bg-opacity-90 border border-blueGray-100 rounded-xl shadow-11xl">
                                ...
                                <p class="font-medium leading-relaxed">+250 790 006118</p>
                                <p class="font-medium leading-relaxed">+254 725 464827</p>
                            </div>
                        </div>
                        <div class="w-full md:w-1/3 p-3">
                            <div class="p-11 h-full text-center bg-white bg-opacity-90 border border-blueGray-100 rounded-xl shadow-11xl">
                                ...
                                <p class="font-medium max-w-xs mx-auto leading-relaxed">KK 242 Street, Kigali, Rwanda</p>
                            </div>
                        </div>
                    </div>
                </div>
